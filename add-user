...
-c FullName,Phone,OtherInfo dima && echo dima:Qt8pQEXnrWW | chpasswd
...
-c FullName,Phone,OtherInfo oleg && echo oleg:PDExf7qWvHh | chpasswd
...
-c FullName,Phone,OtherInfo bohdan && echo bohdan:b4yTvEXrDLt | chpasswd
...
-c FullName,Phone,OtherInfo rostislav && echo rostislav:fecJtg7PWmn | chpasswd
